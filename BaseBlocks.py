...
class BasicDSConvConv2d(nn.Module):
    def __init__(
        self, in_planes, out_planes, kernel_size, stride=1, padding=0, bias=False,
    ):
        super(BasicDSConvConv2d, self).__init__()
